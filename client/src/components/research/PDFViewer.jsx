      ...
      <div className="bg-gray-900 px-6 py-4 flex items-center justify-between z-40 border-b border-gray-700">
        ...
        <div className="flex items-center gap-2">
          <a 
            ...
            className="p-2 bg-gray-800 hover:bg-gray-700 text-white rounded-lg transition flex items-center gap-2"
        ...
        {error && (
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-30 p-8">
            ...
            <p className="text-gray-400 mb-6 text-center max-w-md">
              The PDF viewer is having trouble loading the document. Please try opening it in a new tab.
            </p>
            <div className="flex flex-col gap-3 w-full max-w-md">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-center justify-center gap-2 bg-navy text-white px-6 py-3 rounded-lg hover:bg-navy-800"
              >
                <ExternalLink size={18} />
                Open PDF in New Tab
              </a>
