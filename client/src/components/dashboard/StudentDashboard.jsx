              ...
              <div className="p-3 sm:p-4">
                {filteredSubmissions.length === 0 ? (
                  <div className="text-center py-8 sm:py-12">
                    ...
                    {!search && (
                      <button onClick={() => setShowSubmitModal(true)} className="text-sm sm:text-base text-navy dark:text-accent font-semibold hover:underline">
              ...
              <div className="p-3 sm:p-4">
                {filteredBookmarks.length === 0 ? (
                  <div className="text-center py-8 sm:py-12">
                    ...
                    {!search && (
                      <button onClick={() => window.location.href = '/explore'} className="text-sm sm:text-base text-navy dark:text-accent font-semibold hover:underline">
                        Browse Papers
                      </button>
                    )}
                  </div>
