...
import { Mail, MapPin, ArrowUp, Lock, Shield } from 'lucide-react';
...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-6 mt-auto border-t-2 border-navy">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <a href="https://neust.edu.ph/" target="_blank" rel="noopener noreferrer" 
                className="w-8 h-8 rounded-full border border-navy shadow-sm hover:scale-110 transition overflow-hidden bg-white flex items-center justify-center"
                title="NEUST">
                {logos.school?.url ? (
              ...
              {/* ConServe Logo */}
              <Link to="/" 
                className="w-8 h-8 rounded-md border border-accent shadow-sm hover:scale-110 transition overflow-hidden bg-navy flex items-center justify-center"
                title="ConServe">
                {logos.conserve?.url ? (
            ...
            <h3 className="text-white font-bold text-base mb-1">CONserve</h3>
            <p className="text-xs text-gray-400 leading-relaxed">NEUST College of Nursing Research Repository - Preserving academic excellence.</p>
          </div>
          ...
          {/* Contact & Support */}
          <div>
            <h3 className="text-white font-semibold mb-2 text-sm">Contact & Support</h3>
            ...
            <Link to="/help" className="inline-block bg-navy text-white px-3 py-1.5 rounded-md text-xs font-semibold hover:bg-navy-800 shadow-sm transition">
              Get Help
            </Link>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-2 text-center md:text-left">
          ...
          <div className="flex items-center gap-4">
            <p className="text-xs text-gray-500 flex items-center gap-1">
              ...
              <span>Secured by RA 10173 Data Privacy Act</span>
            </p>

            <button
              onClick={scrollTop}
              className="p-2 bg-navy rounded-full hover:bg-navy-800 shadow-md hover:shadow-lg hover:scale-110 transition-all"
