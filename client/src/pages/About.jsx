    ...
    <div className="max-w-4xl mx-auto animate-fade-in">
            ...
            <div key={i} className="bg-white dark:bg-gray-800 rounded-xl p-5 shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-lg hover:-translate-y-1 transition">
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-navy/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <value.icon className="text-navy" size={20} />
                </div>
                <div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md border border-gray-200 dark:border-gray-700 mb-6">
        <div className="flex items-center justify-between mb-5">
          ...
          {user?.role === 'admin' && (
            <button onClick={() => window.location.href = '/dashboard?tab=team'} className="px-4 py-2 bg-navy text-white rounded-lg hover:bg-navy-800 text-sm font-semibold">
              Manage Team
            </button>
          )}
        </div>
      ...
      <div className="bg-gradient-to-r from-navy to-accent text-white rounded-xl p-6 text-center shadow-lg">
        ...
        <p className="mb-4 text-blue-100 text-sm">Get in touch with us for inquiries or support</p>
