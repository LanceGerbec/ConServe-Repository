...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <section className="relative min-h-[70vh] md:min-h-[85vh] flex items-center justify-center py-8 md:py-16 bg-gradient-to-br from-blue-50 via-peach-50/30 to-blue-100/50 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 marble-texture-light">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center max-w-md md:max-w-2xl mx-auto">
            {user ? (
              <>
                <Link to="/explore" className="group px-6 md:px-10 py-3 md:py-5 bg-gradient-to-r from-navy-900 to-navy-800 text-white rounded-lg md:rounded-xl font-bold shadow-xl shadow-blue-900/30 hover:shadow-2xl hover:shadow-peach-300/40 transition-all duration-300 flex items-center justify-center gap-2 text-base md:text-lg hover:scale-105 hover:from-navy-950 hover:to-navy-900">
                ...
                {(user.role === 'student' || user.role === 'faculty') && (
                  <button onClick={() => setShowSubmitModal(true)} className="px-6 md:px-10 py-3 md:py-5 bg-transparent text-navy-900 dark:text-white rounded-lg md:rounded-xl font-bold shadow-xl shadow-blue-200/30 hover:shadow-2xl hover:shadow-peach-300/40 transition-all duration-300 border-2 border-navy-900 dark:border-navy-600 flex items-center justify-center gap-2 hover:scale-105 text-base md:text-lg hover:bg-gradient-to-r hover:from-navy-900 hover:to-navy-800 hover:text-white dark:hover:from-navy-600 dark:hover:to-navy-700">
              ...
              <>
                ...
                <Link to="/about" className="px-6 md:px-10 py-3 md:py-5 bg-transparent text-navy-900 dark:text-white rounded-lg md:rounded-xl font-bold shadow-xl shadow-blue-200/30 hover:shadow-2xl hover:shadow-peach-300/40 transition-all duration-300 border-2 border-navy-900 dark:border-navy-600 hover:scale-105 text-base md:text-lg hover:bg-gradient-to-r hover:from-navy-900 hover:to-navy-800 hover:text-white dark:hover:from-navy-600 dark:hover:to-navy-700">
                  Learn More
                </Link>
              </>
            )}
      ...
      {/* Divider with Peach Accent */}
      <div className="h-1 bg-gradient-to-r from-blue-400 via-navy-600 via-peach-400/50 to-blue-400 dark:from-blue-600 dark:via-navy-700 dark:to-blue-600"></div>
      ...
      <section className="px-4 py-12 md:py-20 max-w-7xl mx-auto bg-gradient-to-b from-white via-blue-50/30 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="flex md:hidden overflow-x-auto gap-5 px-4 pb-4 snap-x snap-mandatory scrollbar-hide">
          {features.map((f, i) => (
            <div 
              key={i} 
              className={`flex-shrink-0 w-[85vw] group bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg shadow-blue-200/30 hover:shadow-2xl hover:shadow-peach-300/30 transition-all border-2 snap-center marble-hover ${
                activeFeature === i 
        ...
        <div className="hidden md:grid grid-cols-2 md:grid-cols-3 gap-5 md:gap-8 lg:gap-10">
          {features.map((f, i) => (
            <div 
              key={i} 
              className={`group bg-white dark:bg-gray-800 p-6 md:p-8 lg:p-10 rounded-xl md:rounded-2xl shadow-lg shadow-blue-200/30 hover:shadow-2xl hover:shadow-peach-300/30 transition-all border-2 cursor-pointer marble-hover ${
                activeFeature === i 
                  ? 'border-navy-600 dark:border-accent scale-105 shadow-xl' 
                  : 'border-gray-200 dark:border-gray-700 hover:border-navy-400 dark:hover:border-navy-600'
              }`}
      ...
      {/* Divider with Peach Accent */}
      <div className="h-1 bg-gradient-to-r from-blue-400 via-navy-600 via-peach-400/50 to-blue-400 dark:from-blue-600 dark:via-navy-700 dark:to-blue-600 mx-auto max-w-6xl"></div>
        ...
        <div className="bg-gradient-to-br from-navy-900 via-blue-900 to-navy-800 dark:from-gray-900 dark:via-navy-950 dark:to-gray-950 rounded-2xl md:rounded-3xl p-8 md:p-14 lg:p-20 shadow-2xl shadow-blue-900/50 border-2 border-navy-700 dark:border-navy-800">
          ...
          <div className="flex md:hidden overflow-x-auto gap-4 pb-4 snap-x snap-mandatory scrollbar-hide -mx-4 px-4">
            {benefits.map((b, i) => (
              <div 
                key={i} 
                className="flex-shrink-0 w-[70vw] sm:w-[45vw] group flex flex-col items-center gap-3 bg-gradient-to-br from-white/10 via-peach-200/5 to-blue-500/5 backdrop-blur-md p-5 rounded-xl border-2 border-white/20 hover:bg-white/20 hover:scale-105 hover:border-peach-300/40 transition-all shadow-lg shadow-blue-900/30 hover:shadow-2xl hover:shadow-peach-300/40 snap-center"
              >
          ...
          <div className="hidden md:grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 lg:gap-10 max-w-6xl mx-auto">
            {benefits.map((b, i) => (
              <div 
                key={i} 
                className="group flex flex-col items-center gap-3 md:gap-5 bg-gradient-to-br from-white/10 via-peach-200/5 to-blue-500/5 backdrop-blur-md p-5 md:p-7 lg:p-10 rounded-xl md:rounded-2xl border-2 border-white/20 hover:bg-white/20 hover:scale-105 hover:border-peach-300/40 transition-all shadow-lg shadow-blue-900/30 hover:shadow-2xl hover:shadow-peach-300/40"
              >
      ...
      {/* CTA Section with Marble Texture */}
      <section className="px-4 py-12 md:py-20 max-w-4xl md:max-w-5xl mx-auto mb-8">
        <div className="bg-gradient-to-br from-navy-950 via-blue-900/90 to-navy-900 dark:from-gray-900 dark:via-navy-950 dark:to-gray-950 rounded-2xl md:rounded-3xl p-8 md:p-14 lg:p-20 shadow-2xl shadow-blue-900/50 text-center border-2 border-navy-700 dark:border-navy-800 marble-texture-dark">
          {!user ? (
            <>
              ...
              <Link 
                to="/register" 
                className="group inline-flex items-center gap-2 md:gap-3 px-10 md:px-14 py-4 md:py-6 bg-white text-navy-900 rounded-xl md:rounded-2xl font-black shadow-2xl shadow-white/20 hover:scale-105 transition-all text-base md:text-lg lg:text-xl tracking-wide hover:shadow-peach-300/40"
              >
                Get Started Free
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-5 justify-center">
                {(user.role === 'student' || user.role === 'faculty') && (
                  <button 
                    ...
                    className="group px-8 md:px-12 py-4 md:py-6 bg-white text-navy-900 rounded-xl md:rounded-2xl font-black shadow-2xl shadow-white/20 hover:scale-105 transition-all flex items-center justify-center gap-2 text-base md:text-lg tracking-wide hover:shadow-peach-300/40"
                  >
