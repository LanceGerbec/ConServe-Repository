    ...
    <div className="space-y-16 md:space-y-24 pb-12">
      ...
      <section className="px-4 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {features.map((f, i) => (
            <div key={i} className={`group bg-white dark:bg-gray-800 p-6 md:p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border-2 cursor-pointer ${activeFeature === i ? 'border-navy dark:border-blue-500 scale-105 ring-4 ring-navy/10 dark:ring-blue-500/20' : 'border-gray-200 dark:border-gray-700 hover:border-navy/30 dark:hover:border-blue-500/30'}`} onClick={() => setActiveFeature(i)}>
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-navy via-blue-700 to-purple-700 dark:from-gray-900 dark:via-navy-900 dark:to-gray-900 rounded-3xl p-8 md:p-12 shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-4xl mx-auto">
              {benefits.map((b, i) => (
                <div key={i} className="flex items-center gap-3 md:gap-4 bg-white/10 backdrop-blur-sm p-4 md:p-6 rounded-2xl border border-white/20 hover:bg-white/20 hover:border-white/40 hover:scale-105 transition-all duration-300 shadow-lg">
        ...
        <section className="px-4 max-w-4xl mx-auto">
          <div className="relative overflow-hidden bg-gradient-to-br from-navy via-blue-700 to-purple-700 dark:from-gray-900 dark:via-navy-900 dark:to-purple-900 rounded-3xl p-8 md:p-12 shadow-2xl">
            ...
            <div className="relative z-10 text-center">
              ...
              <Link to="/register" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-navy rounded-2xl font-bold shadow-2xl hover:scale-105 hover:shadow-white/20 transition-all">
                Get Started Free<ArrowRight size={20} className="flex-shrink-0" />
              </Link>
            </div>
          </div>
        </section>
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-navy via-blue-700 to-purple-700 dark:from-gray-900 dark:via-navy-900 dark:to-purple-900 rounded-3xl p-8 md:p-12 shadow-2xl">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="flex flex-col md:flex-row gap-3 md:gap-4 justify-center">
                ...
                <Link to="/explore" className="px-6 py-3 bg-white/20 backdrop-blur-sm text-white rounded-xl font-bold hover:scale-105 hover:bg-white/30 transition border-2 border-white/30 flex items-center justify-center gap-2">
                  <Search size={20} className="flex-shrink-0" />Browse Papers
                </Link>
              </div>
            </div>
          </div>
