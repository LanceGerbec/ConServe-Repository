    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <section className="relative min-h-[70vh] md:min-h-[85vh] flex items-center justify-center py-8 md:py-16 bg-gradient-to-br from-navy-900 via-navy-800 to-blue-900 dark:from-gray-900 dark:via-navy-950 dark:to-gray-950">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-4">
          ...
          <p className="text-lg md:text-2xl lg:text-3xl text-blue-200 dark:text-blue-300 mb-2 md:mb-4 font-bold tracking-wide">
            Where Knowledge Flows and Nursing Grows
          </p>
          
          <p className="text-sm md:text-lg text-blue-100 dark:text-blue-200 mb-6 md:mb-10 font-medium">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center max-w-md md:max-w-2xl mx-auto">
            {user ? (
              <>
                <Link to="/explore" className="group px-6 md:px-10 py-3 md:py-5 bg-white text-navy-900 rounded-lg md:rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all flex items-center justify-center gap-2 text-base md:text-lg hover:scale-105">
                ...
                {(user.role === 'student' || user.role === 'faculty') && (
                  <button onClick={() => setShowSubmitModal(true)} className="px-6 md:px-10 py-3 md:py-5 bg-navy-700/80 backdrop-blur-sm text-white rounded-lg md:rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all border-2 border-white/20 flex items-center justify-center gap-2 hover:scale-105 text-base md:text-lg hover:bg-navy-600/80">
              ...
              <>
                <Link to="/register" className="group px-6 md:px-10 py-3 md:py-5 bg-white text-navy-900 rounded-lg md:rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all flex items-center justify-center gap-2 text-base md:text-lg hover:scale-105">
                  Get Started Free
                  <ArrowRight size={18} className="md:w-6 md:h-6 group-hover:translate-x-1 transition-transform" />
                </Link>
                <Link to="/about" className="px-6 md:px-10 py-3 md:py-5 bg-navy-700/80 backdrop-blur-sm text-white rounded-lg md:rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all border-2 border-white/20 hover:scale-105 text-base md:text-lg hover:bg-navy-600/80">
                  Learn More
                </Link>
              </>
            )}
