              ...
              <ol className="space-y-2">
                {guide.steps.map((step, j) => (
                  <li key={j} className="flex items-start text-sm">
                    <span className="flex items-center justify-center w-5 h-5 bg-navy dark:bg-blue-600 text-white rounded-full text-xs font-bold mr-2 flex-shrink-0 mt-0.5">
                      {j + 1}
                    </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {popularFaqs.map((faq, i) => (
              <button
                ...
                className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 p-4 rounded-xl border-2 border-yellow-200 dark:border-yellow-700 hover:shadow-md transition text-left"
              >
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-3 flex-1">
                      {faq.popular && <Award size={16} className="text-yellow-500 dark:text-yellow-400 flex-shrink-0" />}
                      <span className="font-semibold text-gray-900 dark:text-white pr-4">{faq.q}</span>
                    </div>
                    <ChevronDown 
                      className={`text-navy dark:text-blue-400 transition-transform flex-shrink-0 ${openFaq === originalIndex ? 'rotate-180' : ''}`} 
                      size={18} 
                    />
                  </button>
      ...
      <div className="bg-gradient-to-r from-navy to-accent dark:from-blue-700 dark:to-blue-900 text-white rounded-xl p-6 text-center shadow-lg">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <a 
            ...
            className="inline-block bg-white text-navy dark:text-blue-900 px-6 py-3 rounded-lg font-bold hover:bg-gray-100 transition"
          >
            Email Support
          </a>
          <a 
