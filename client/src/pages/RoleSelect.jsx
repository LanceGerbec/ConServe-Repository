...
const RoleSelect = () => {
  ...
  const roles = [
    { path: '/login/student', icon: BookOpen, title: 'Student', desc: 'Access research papers and submit your work', gradient: 'from-green-500 to-green-600', bgGradient: 'from-green-50 to-green-100', darkBg: 'dark:from-green-900/20 dark:to-green-800/20' },
    { path: '/login/faculty', icon: Users, title: 'Faculty', desc: 'Review papers, provide feedback, and submit research', gradient: 'from-blue-500 to-blue-600', bgGradient: 'from-blue-50 to-blue-100', darkBg: 'dark:from-blue-900/20 dark:to-blue-800/20' }
  ];
      ...
      <div className="min-h-screen bg-gradient-to-br from-navy-950 via-navy-900 to-navy-800 flex items-center justify-center p-4 sm:p-6">
        ...
        <div className="w-full max-w-4xl">
          <div className="text-center mb-8 sm:mb-12 animate-fade-in px-4">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-3 sm:mb-4 leading-tight">Welcome to <span className="text-blue-400">CONserve</span></h1>
            <p className="text-base sm:text-lg md:text-xl text-gray-200 px-2">Select your role to access the research repository</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-8 sm:mb-10 px-4 max-w-3xl mx-auto">
